    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="huanzheId" name="huanzheId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="体检编号" prop="tijianUuidNumber">
                       <el-input v-model="ruleForm.tijianUuidNumber"
                                 placeholder="体检编号" clearable  :readonly="ro.tijianUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="体检编号" prop="tijianUuidNumber">
                           <el-input v-model="ruleForm.tijianUuidNumber"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="左眼度数" prop="zuoyandushu">
                       <el-input v-model="ruleForm.zuoyandushu"
                                 placeholder="左眼度数" clearable  :readonly="ro.zuoyandushu"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="左眼度数" prop="zuoyandushu">
                           <el-input v-model="ruleForm.zuoyandushu"
                                     placeholder="左眼度数" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="右眼度数" prop="youyandushu">
                       <el-input v-model="ruleForm.youyandushu"
                                 placeholder="右眼度数" clearable  :readonly="ro.youyandushu"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="右眼度数" prop="youyandushu">
                           <el-input v-model="ruleForm.youyandushu"
                                     placeholder="右眼度数" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="心音" prop="xinyin">
                       <el-input v-model="ruleForm.xinyin"
                                 placeholder="心音" clearable  :readonly="ro.xinyin"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="心音" prop="xinyin">
                           <el-input v-model="ruleForm.xinyin"
                                     placeholder="心音" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="肺部听诊" prop="feibutingzhen">
                       <el-input v-model="ruleForm.feibutingzhen"
                                 placeholder="肺部听诊" clearable  :readonly="ro.feibutingzhen"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="肺部听诊" prop="feibutingzhen">
                           <el-input v-model="ruleForm.feibutingzhen"
                                     placeholder="肺部听诊" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="肝脏听诊" prop="ganzangtingzhen">
                       <el-input v-model="ruleForm.ganzangtingzhen"
                                 placeholder="肝脏听诊" clearable  :readonly="ro.ganzangtingzhen"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="肝脏听诊" prop="ganzangtingzhen">
                           <el-input v-model="ruleForm.ganzangtingzhen"
                                     placeholder="肝脏听诊" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="血常规详情" prop="xuechangguiText">
                        <el-input type="textarea"  :readonly="ro.xuechangguiText" v-model="ruleForm.xuechangguiText" placeholder="血常规详情"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.xuechangguiText" label="血常规详情" prop="xuechangguiText">
                            <span v-html="ruleForm.xuechangguiText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="尿常规详情" prop="niaochangguiText">
                        <el-input type="textarea"  :readonly="ro.niaochangguiText" v-model="ruleForm.niaochangguiText" placeholder="尿常规详情"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.niaochangguiText" label="尿常规详情" prop="niaochangguiText">
                            <span v-html="ruleForm.niaochangguiText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="其他详情" prop="qitaText">
                        <el-input type="textarea"  :readonly="ro.qitaText" v-model="ruleForm.qitaText" placeholder="其他详情"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.qitaText" label="其他详情" prop="qitaText">
                            <span v-html="ruleForm.qitaText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    xinyin: false,
                    feibutingzhen: false,
                    ganzangtingzhen: false,
                    xuechangguiText: false,
                    niaochangguiText: false,
                    qitaText: false,
                    insertTime: false,
                },
                ruleForm: {
                    yishengId: '',
                    huanzheId: '',
                    tijianUuidNumber: new Date().getTime(),
                    tizhong: '',
                    shengao: '',
                    zuoyandushu: '',
                    youyandushu: '',
                ...
                rules: {
                   ...
                   tijianUuidNumber: [
                              { required: true, message: '体检编号不能为空', trigger: 'blur' },
                          ],
                   tizhong: [
                   ...
                   zuoyandushu: [
                              { required: true, message: '左眼度数不能为空', trigger: 'blur' },
                          ],
                   youyandushu: [
                              { required: true, message: '右眼度数不能为空', trigger: 'blur' },
                          ],
                   xinlv: [
                              { required: true, message: '心率不能为空', trigger: 'blur' },
                          ],
                   xinyin: [
                              { required: true, message: '心音不能为空', trigger: 'blur' },
                          ],
                   feibutingzhen: [
                              { required: true, message: '肺部听诊不能为空', trigger: 'blur' },
                          ],
                   ganzangtingzhen: [
                              { required: true, message: '肝脏听诊不能为空', trigger: 'blur' },
                          ],
                   xuechangguiText: [
                              { required: true, message: '血常规详情不能为空', trigger: 'blur' },
                          ],
                   niaochangguiText: [
                              { required: true, message: '尿常规详情不能为空', trigger: 'blur' },
                          ],
                   qitaText: [
                              { required: true, message: '其他详情不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
