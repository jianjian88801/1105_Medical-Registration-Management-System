<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='guahao'">
                    <el-form-item class="select" v-if="type!='info'"  label="挂号" prop="guahaoId">
                        <el-select v-model="ruleForm.guahaoId" :disabled="ro.guahaoId" filterable placeholder="请选择挂号" @change="guahaoChange">
                            <el-option
                                    v-for="(item,index) in guahaoOptions"
                                    v-bind:key="item.id"
                                    :label="item.guahaoUuidNumber"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='guahao' ">
                    <el-form-item class="input" v-if="type!='info'"  label="号" prop="guahaoUuidNumber">
                        <el-input v-model="guahaoForm.guahaoUuidNumber"
                                  placeholder="号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
            ...
            <input id="guahaoId" name="guahaoId" type="hidden">
            <input id="yishengId" name="yishengId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="患者主诉" prop="zhusuContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.zhusuContent" label="患者主诉" prop="zhusuContent">
                            <span v-html="ruleForm.zhusuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="诊断结果" prop="zhenduanContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.zhenduanContent" label="诊断结果" prop="zhenduanContent">
                            <span v-html="ruleForm.zhenduanContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="开药详情" prop="kaiyaoContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.kaiyaoContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.kaiyaoContent" label="开药详情" prop="kaiyaoContent">
                            <span v-html="ruleForm.kaiyaoContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12" v-if="sessionTable != 'yisheng'">
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   guahaoId: [
                              { required: true, message: '挂号不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   kaiyaoContent: [
                              { required: true, message: '开药详情不能为空', trigger: 'blur' },
                          ],
                   bingliTypes: [
        ...
        created() {
         ...
         this.$http({
             url: `guahao/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.guahaoOptions = data.data.list;
            }
         });
         this.$http({
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.guahaoChange(data.data.guahaoId)
